...
"")
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icon/graphics/baseline_save_black_24dp.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.saveAsBtn.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icon/graphics/baseline_exit_to_app_black_24dp.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.actionOpenConfigFolder.setIcon(icon3)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icon/graphics/baseline_file_copy_black_24dp.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
