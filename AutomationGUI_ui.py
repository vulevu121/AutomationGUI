...
"}")
        ...
        self.generalLayout.addWidget(self.reloadVariablePoolBtn, 6, 3, 1, 1)
        ...
        self.horizontalLayout_7.addWidget(self.polarionTableView)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/svg/icons/file.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
