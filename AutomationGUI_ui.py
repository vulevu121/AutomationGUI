...
"}")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icon/excel"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icon/menu"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icon/folderOpen"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.browseTestCaseExcelBtn.sizePolicy().hasHeightForWidth())
        self.browseTestCaseExcelBtn.setSizePolicy(sizePolicy)
        self.browseTestCaseExcelBtn.setIcon(icon1)
        self.browseTestCaseExcelBtn.setIconSize(QtCore.QSize(24, 24))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.callFunctionFolderToolButton.sizePolicy().hasHeightForWidth())
        self.callFunctionFolderToolButton.setSizePolicy(sizePolicy)
        self.callFunctionFolderToolButton.setText("")
        self.callFunctionFolderToolButton.setIcon(icon2)
        self.callFunctionFolderToolButton.setIconSize(QtCore.QSize(24, 24))
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icon/copy"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.browseCallFunctionBtn.sizePolicy().hasHeightForWidth())
        self.browseCallFunctionBtn.setSizePolicy(sizePolicy)
        self.browseCallFunctionBtn.setIcon(icon3)
        self.browseCallFunctionBtn.setIconSize(QtCore.QSize(24, 24))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.testCaseExcelToolButton.sizePolicy().hasHeightForWidth())
        self.testCaseExcelToolButton.setSizePolicy(sizePolicy)
        self.testCaseExcelToolButton.setText("")
        self.testCaseExcelToolButton.setIcon(icon2)
        self.testCaseExcelToolButton.setIconSize(QtCore.QSize(24, 24))
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icon/tune"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icon/eventNote"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icon/code"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icon/save"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.polarionSaveExcelButton.setIcon(icon8)
        ...
        self.polarionCopyRunListButton = QtWidgets.QToolButton(self.tab_6)
        self.polarionCopyRunListButton.setIcon(icon4)
        self.polarionCopyRunListButton.setIconSize(QtCore.QSize(24, 24))
        self.polarionCopyRunListButton.setObjectName("polarionCopyRunListButton")
        self.verticalLayout_10.addWidget(self.polarionCopyRunListButton)
        self.polarionUpdatePassedButton = QtWidgets.QToolButton(self.tab_6)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icon/verdictPassed"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.polarionUpdatePassedButton.setIcon(icon9)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icon/verdictAll"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.polarionUpdateAllButton.setIcon(icon10)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/icon/history"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.polarionUpdateRevisionButton.setIcon(icon11)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/icon/numberedList"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.updateStepsButton.setIcon(icon12)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/icon/link"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.updateHyperlinksButton.setIcon(icon13)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/icon/polarion"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.tbxLineEdit = QtWidgets.QLineEdit(self.tab_4)
        self.tbxLineEdit.setObjectName("tbxLineEdit")
        self.horizontalLayout_5.addWidget(self.tbxLineEdit)
        self.tbxBrowseButton = QtWidgets.QToolButton(self.tab_4)
        self.tbxBrowseButton.setObjectName("tbxBrowseButton")
        self.horizontalLayout_5.addWidget(self.tbxBrowseButton)
        self.tbxConvertButton = QtWidgets.QPushButton(self.tab_4)
        self.tbxConvertButton.setObjectName("tbxConvertButton")
        self.horizontalLayout_5.addWidget(self.tbxConvertButton)
        self.verticalLayout_16.addLayout(self.horizontalLayout_5)
        self.horizontalLayout_9 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_9.setObjectName("horizontalLayout_9")
        self.tbxTitleLineEdit = QtWidgets.QLineEdit(self.tab_4)
        self.tbxTitleLineEdit.setObjectName("tbxTitleLineEdit")
        self.horizontalLayout_9.addWidget(self.tbxTitleLineEdit)
        self.tbxCopyTitleButton = QtWidgets.QPushButton(self.tab_4)
        self.tbxCopyTitleButton.setObjectName("tbxCopyTitleButton")
        self.horizontalLayout_9.addWidget(self.tbxCopyTitleButton)
        self.verticalLayout_16.addLayout(self.horizontalLayout_9)
        self.horizontalLayout_10 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_10.setObjectName("horizontalLayout_10")
        self.tbxDescLineEdit = QtWidgets.QLineEdit(self.tab_4)
        self.tbxDescLineEdit.setObjectName("tbxDescLineEdit")
        self.horizontalLayout_10.addWidget(self.tbxDescLineEdit)
        self.tbxCopyDescButton = QtWidgets.QPushButton(self.tab_4)
        self.tbxCopyDescButton.setObjectName("tbxCopyDescButton")
        self.horizontalLayout_10.addWidget(self.tbxCopyDescButton)
        self.verticalLayout_16.addLayout(self.horizontalLayout_10)
        self.horizontalLayout_12 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_12.setObjectName("horizontalLayout_12")
        self.tbxPlainTextEdit = QtWidgets.QPlainTextEdit(self.tab_4)
        self.tbxPlainTextEdit.setObjectName("tbxPlainTextEdit")
        self.horizontalLayout_12.addWidget(self.tbxPlainTextEdit)
        self.verticalLayout_15 = QtWidgets.QVBoxLayout()
        self.verticalLayout_15.setObjectName("verticalLayout_15")
        self.tbxCopyTextButton = QtWidgets.QToolButton(self.tab_4)
        self.tbxCopyTextButton.setObjectName("tbxCopyTextButton")
        self.verticalLayout_15.addWidget(self.tbxCopyTextButton)
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/icon/automationDesk"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.tab_4, icon15, "")
...
"}")
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/icon/navigateNext"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/icon/info"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAbout.setIcon(icon17)
        self.actionAbout.setObjectName("actionAbout")
        self.actionConfigFolder = QtWidgets.QAction(MainWindow)
        self.actionConfigFolder.setIcon(icon3)
        self.actionConfigFolder.setObjectName("actionConfigFolder")
        self.actionLoad = QtWidgets.QAction(MainWindow)
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/icon/load"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(":/icon/new"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.versionAddButton.setText(_translate("MainWindow", "Add Row"))
        self.versionRemoveButton.setText(_translate("MainWindow", "Remove Row"))
...
"and Additional Signals"))
        ...
        self.polarionCopyRunListButton.setToolTip(_translate("MainWindow", "Copy Yes/No column"))
        self.polarionCopyRunListButton.setText(_translate("MainWindow", "Copy Yes/No"))
        ...
        self.tbxLineEdit.setPlaceholderText(_translate("MainWindow", "Browse for TBX file..."))
        self.tbxBrowseButton.setText(_translate("MainWindow", "..."))
        self.tbxConvertButton.setText(_translate("MainWindow", "Convert"))
        self.tbxTitleLineEdit.setPlaceholderText(_translate("MainWindow", "Title"))
        self.tbxCopyTitleButton.setText(_translate("MainWindow", "Copy Title"))
        self.tbxDescLineEdit.setPlaceholderText(_translate("MainWindow", "Description"))
        self.tbxCopyDescButton.setText(_translate("MainWindow", "Copy Desc"))
        self.tbxCopyTextButton.setText(_translate("MainWindow", "Copy"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), _translate("MainWindow", "Convert AD Blocks"))
