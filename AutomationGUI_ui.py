...
"}")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icon/tabSelectedIcon"), QtGui.QIcon.Normal, QtGui.QIcon.On)
...
"}")
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icon/dSpaceIcon"), QtGui.QIcon.Normal, QtGui.QIcon.On)
...
"}")
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icon/passedVerdictIcon"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.polarionUpdatePassedButton.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icon/allVerdictsIcon"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.polarionUpdateAllButton.setIcon(icon9)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icon/historyIcon"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.polarionUpdateRevisionButton.setIcon(icon10)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/icon/numberedListIcon"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.updateStepsButton.setIcon(icon11)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/icon/linkIcon"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.updateHyperlinksButton.setIcon(icon12)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/icon/polarionIcon"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.tabWidget.addTab(self.tab_6, icon13, "")
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/icon/settingIcon"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        self.bottombuttonsLayout.addItem(spacerItem3)
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/icon/graphics/baseline_exit_to_app_black_24dp.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.exitButton.setIcon(icon15)
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/icon/saveColorIcon"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/icon/contactColorIcon"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAbout.setIcon(icon17)
        self.actionAbout.setObjectName("actionAbout")
        self.actionConfigFolder = QtWidgets.QAction(MainWindow)
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/icon/folderColorIcon"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionConfigFolder.setIcon(icon18)
        self.actionConfigFolder.setObjectName("actionConfigFolder")
        self.actionLoad = QtWidgets.QAction(MainWindow)
        self.actionLoad.setIcon(icon18)
        ...
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(":/icon/newColorIcon"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        MainWindow.setTabOrder(self.removeDtcExBtn, self.updateVariablePoolCheckBox)
