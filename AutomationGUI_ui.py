...
"and Additional Signals"))
        ...
        self.runEdit.setPlaceholderText(_translate("MainWindow", "Paste the test case list here..."))
        self.runYesNoEdit.setPlaceholderText(_translate("MainWindow", "[yes] for passed test cases and [no] for failed test cases"))
