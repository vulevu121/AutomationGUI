...
"")
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(20, 10, 721, 261))
        ...
        self.variablePoolLabel = QtWidgets.QLabel(self.layoutWidget)
        self.variablePoolLabel.setObjectName("variablePoolLabel")
        self.gridLayout.addWidget(self.variablePoolLabel, 2, 0, 1, 1)
        ...
        self.callFunctionLabel = QtWidgets.QLabel(self.layoutWidget)
        self.callFunctionLabel.setObjectName("callFunctionLabel")
        self.gridLayout.addWidget(self.callFunctionLabel, 0, 0, 1, 1)
        self.csvReportLabel = QtWidgets.QLabel(self.layoutWidget)
        self.csvReportLabel.setObjectName("csvReportLabel")
        self.gridLayout.addWidget(self.csvReportLabel, 1, 0, 1, 1)
        ...
        self.openCallFunctionFolderButton = QtWidgets.QPushButton(self.layoutWidget)
        ...
        self.gridLayout.addWidget(self.openCallFunctionFolderButton, 0, 3, 1, 1)
        self.openVarPoolFolderButton = QtWidgets.QPushButton(self.layoutWidget)
        ...
        self.gridLayout.addWidget(self.openVarPoolFolderButton, 2, 3, 1, 1)
        self.openCsvReportFolderButton = QtWidgets.QPushButton(self.layoutWidget)
        ...
        self.gridLayout.addWidget(self.openCsvReportFolderButton, 1, 3, 1, 1)
        ...
        self.layoutWidget6.setGeometry(QtCore.QRect(390, 360, 390, 52))
